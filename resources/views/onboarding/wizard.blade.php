...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dot-label   { font-size: 0.78rem; font-weight: 600; color: #475569; }
        .dot-label.active { color: #1d4ed8; }
        .connector   { width: 40px; height: 2px; background: #e2e8f0; }
        ...
        .wyg-title { font-size: 0.88rem; font-weight: 700; color: #0f172a; margin-bottom: 4px; }
        .wyg-desc  { font-size: 0.78rem; color: #64748b; line-height: 1.5; }
        ...
        .tour-header p  { font-size: 0.88rem; color: #64748b; margin-bottom: 20px; }
        ...
        .mock-title { font-size: 0.75rem; font-weight: 600; color: #475569; margin-left: 4px; }
        ...
        .mock-stat-label { font-size: 0.68rem; color: #94a3b8; }
        ...
        .mock-row-icon { width: 28px; height: 28px; border-radius: 7px; display: flex; align-items: center; justify-content: center; font-size: 0.8rem; flex-shrink: 0; }
        .mock-row-label { flex: 1; font-size: 0.78rem; color: #334155; font-weight: 500; }
        .mock-row-amount { font-size: 0.8rem; font-weight: 700; }

        .mock-progress-item { margin-bottom: 10px; }
        .mock-prog-header { display: flex; justify-content: space-between; margin-bottom: 4px; }
        .mock-prog-name  { font-size: 0.78rem; color: #334155; font-weight: 600; }
        .mock-prog-pct   { font-size: 0.72rem; color: #64748b; }
        ...
        .tour-explain p  { font-size: 0.88rem; color: #475569; line-height: 1.7; margin-bottom: 12px; }
        ...
        .step-ready p  { font-size: 0.95rem; color: #64748b; max-width: 480px; margin: 0 auto 32px; line-height: 1.7; }
        ...
        .setup-checklist h4 { font-size: 0.82rem; font-weight: 700; text-transform: uppercase; letter-spacing: .06em; color: #64748b; margin-bottom: 14px; }
        .setup-item {
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        .setup-label { font-size: 0.88rem; color: #334155; font-weight: 500; }
        .setup-note  { font-size: 0.75rem; color: #94a3b8; }
        ...
        .first-step-item span { font-size: 0.78rem; font-weight: 600; color: #334155; display: block; }
        ...
        .step-counter { font-size: 0.78rem; color: #94a3b8; font-weight: 500; }

        @media (max-width: 540px) {
            .welcome-body, .tour-header, .tour-panels, .step-ready { padding-left: 20px; padding-right: 20px; }
            .wizard-footer { padding: 16px 20px; }
            .what-you-get { grid-template-columns: 1fr 1fr; }
...
<body>
    ...
    <div class="progress-bar-wrap" id="progressDots">
        ...
        <div class="progress-step">
            ...
            <div class="dot-label" id="label-2">Quick Tour</div>
        </div>
        <div class="connector" id="conn-2"></div>
        <div class="progress-step">
            <div class="dot pending" id="dot-3">3</div>
            <div class="dot-label" id="label-3">Ready!</div>
        </div>
    </div>
    ...
    <div class="wizard-card">
        ...
        {{-- ════ STEP 1: WELCOME ════ --}}
        <div class="step step-welcome active" id="step-1">
        ...
        {{-- ════ STEP 2: QUICK TOUR ════ --}}
        <div class="step step-tour" id="step-2">
            <div class="tour-header">
                ...
                <div class="tour-tabs" id="tourTabs">
                    <button class="tour-tab active" data-panel="transactions" onclick="showPanel('transactions', this)">Transactions</button>
                    <button class="tour-tab" data-panel="budgets" onclick="showPanel('budgets', this)">Budgets</button>
                    <button class="tour-tab" data-panel="goals" onclick="showPanel('goals', this)">Goals</button>
                    <button class="tour-tab" data-panel="reports" onclick="showPanel('reports', this)">Reports</button>
                </div>
            </div>
            ...
            <div class="tour-panels">
                ...
                <div class="tour-panel" id="panel-budgets">
                    <div class="mock-screen">
                        ...
                        <div class="mock-body">
                            <div style="font-size:.72rem;font-weight:700;color:#64748b;text-transform:uppercase;letter-spacing:.06em;margin-bottom:10px;">May 2026 · Planning</div>
        ...
        {{-- ════ STEP 3: READY ════ --}}
        <div class="step step-ready" id="step-3">
            <span class="ready-icon">🚀</span>
            <h2>You're all set, {{ auth()->user()->name }}!</h2>
            <p>Everything is ready for you. Here's what was automatically set up, and a few things to do first to get the most out of Bright Finance.</p>
    ...
    <script>
        ...
        function updateDots() {
            for (var i = 1; i <= totalSteps; i++) {
                ...
                dot.innerHTML = i < currentStep ? '<i class="fas fa-check" style="font-size:.65rem;"></i>' : i;
            ...
            if (currentStep === totalSteps) {
                btn.innerHTML = 'Go to Dashboard <i class="fas fa-rocket" style="font-size:.8rem;"></i>';
            } else {
                btn.innerHTML = 'Next <i class="fas fa-arrow-right" style="font-size:.8rem;"></i>';
            }
        }
